  ...
  items: [
    {
      ...
      label: "Ocean Freight",
      description:
        "FCL, LCL and break-bulk shipping across every major trade lane, backed by dedicated route specialists.",
      icon: "ship",
    ...
    },
    {
      ...
      label: "Air Freight",
      description:
        "Priority, deferred and charter air cargo with real-time visibility and door-to-door coverage.",
      icon: "plane",
    ...
    },
    {
      ...
      label: "Road & Rail",
      description:
        "Domestic distribution, cross-border trucking and multimodal rail solutions across the subcontinent.",
      icon: "truck",
    ...
    },
    {
      ...
      description:
        "Licensed CHA services with expert documentation, HS classification and duty optimisation.",
      icon: "document",
    ...
    },
    {
      ...
      label: "Warehouse",
      description:
        "Warehousing, palletisation, packing and end-to-end overseas cargo handling.",
      icon: "box",
    ...
    },
    {
      ...
      description:
        "Express door-to-door courier for documents and small parcels to 200+ destinations.",
      icon: "globe",
...
export const AirFreightService = [
  {
    title: "Air Freight",
...
export const InternationalCourierService = [
  {
    title: "International Courier",
